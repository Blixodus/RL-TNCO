...
network = dict(
        ...
        mean_connectivity=3,
        tensor_dim=6,
        train_files='datasets/train/scalar_product_3D_dataset_num_eqs_450_num_node_100_mean_conn_3.p', # Specify pickle files for training, None -> autogenerated by RL-TNCO
...
model = {
    ...
    'use_bias'                 : False,
    'pretrained_model'         : 'models/xy/epoch_32.model',
    }
