...
network = dict(
        n_nodes=200, # >= num of nodes in the largest tensor network
        n_edges=300, # >= num of edges in the largest tensor network
        mean_connectivity=3,
        tensor_dim=6,
        train_files='datasets/scalar_product_2D_dataset_num_eqs_900_num_node_100_mean_conn_3.p', # Specify pickle files for training, None -> autogenerated by RL-TNCO
...
model = {
    ...
    'use_bias'                 : False,    #
    'pretrained_model'         : 'wandb/run-20250304_165343-x48ul5u6/files/epoch_32.model', # wandb/run-***/files/epoch_32.model
    }
