...
network = dict(
        n_nodes=300, # >= num of nodes in the largest tensor network
        n_edges=500, # >= num of edges in the largest tensor network
        mean_connectivity=3,
        tensor_dim=6,
        train_files='datasets/scalar_product_3D_dataset_num_eqs_450_num_node_100_mean_conn_3.p', # Specify pickle files for training, None -> autogenerated by RL-TNCO
        #test_files='datasets/Sycamore/circuit_n53_m20_s0_e0_pABCDCDAB_simplified_baselines.p',
        #test_files='datasets/random_TNs/for_paper_TN_d_2_6_dataset_num_eqs_1_num_node_25_mean_conn_3.p',
        test_files='datasets/eval-scalar-product-2.p',
        type='random'
        )
...
model = {
    ...
    'use_bias'                 : False,    #
    'pretrained_model'         : 'wandb/run-20250311_133658-r2ne2z6b/files/epoch_32.model', #'wandb/run-20250304_165343-x48ul5u6/files/epoch_32.model', # wandb/run-***/files/epoch_32.model
    }
...
train_params = {
    ...
    'precalc_solver'                          : 'oe_greedy',  # 'ctg_kahypar', 'oe_greedy'
    ...
    'limit_to_baseline_improving_actions'     : True, # Make baselines optional for evaluation ?
